...
WHERE (s.SkillName = 'Percussion' OR s.SkillName = 'Piano Education' OR s.SkillName = 'Sales')
	  AND (e.EmpState LIKE '%Michigan%' OR e.EmpState LIKE '%Georgia%');
...
WHERE vt.VendorTypeName = 'Vintage'
		AND o.OrderDate >= '2009-02-15'
...
WHERE c.CustState LIKE '%California%'
		AND o.OrderDate BETWEEN '2006-01-01' and '2006-12-31'
